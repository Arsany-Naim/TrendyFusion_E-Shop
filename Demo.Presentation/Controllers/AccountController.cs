		...
		public IActionResult SendResetPasswordLink(ForgetPasswordViewModel viewModel)
		{
			if (ModelState.IsValid)
			{
				...
				if(User is not null)
				{
					...
					// BaseUrl/Account/ResetPassword?email=Aliaa@gmail.com&Token
					var ResetPasswordLink = Url.Action(nameof(ResetPassword), "Account", new { email = viewModel.Email  , Token } ,Request.Scheme);
					var email = new Email()
					{
						To = viewModel.Email,
